...
SECRET_KEY = 'django-insecure-whuis46la(!q=(9=d=n)+c&2z9fnknbf!_96)hzhjzu88*6o1u'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': [
        ...
        'rest_framework.renderers.BrowsableAPIRenderer', # закоментировать - Отключение браузерного API
    ],
